...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}
        ...
        \nReqF & Una Codemonkey potrá essere visualizzata solo se ha un Profilo Completo 
        \n
    \end{tabularx}
    ...
    \begin{tabularx}{\textwidth}
        ...
        \hline\rowcolor{tableGreen!60}
        \large\textbf{ID}
               & \large\textbf{Requisito}                                                                % da spostare reqD
        ...
        \nReqF & Si potrá vedere quanti lavori una Codemonkey sta attualmente svolgendo
        \nReqF & Sará possibile vedere la Valutazione della Codemonkey
        \nReqF & Sará possibile vedere a quali Collaborazioni la Codemonkey ha preso parte
