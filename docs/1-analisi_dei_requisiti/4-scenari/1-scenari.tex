...
\begin{tabularx}{\textwidth}
    ...
    \end{enumerate}
    \tableCyan      Scenari Alternativi & Se lo Username è giá stato scelto o l'Email immessa è collegata a un Account giá registrato non sará possibile procedere alla Registrazione dell'Utente
    \ntableCyan     Requisiti NF        & Sia nel caso in cui venga inserito un Username giá esistente, sia nel caso venga inserita una Email associata ad un Account esistente, dovrá essere segnalato all'Utente che non è stato possibile effettuare la Registrazione spiegandone la motivazione
...
\begin{tabularx}{\textwidth}
    ...
    \end{enumerate}
    \tableCyan      Scenari Alternativi &
        2.1. Se il Tag che si vuole aggiungere non è presente tra quelli disponibili, la Codemonkey puó inviare una richiesta per aggiungerlo
...
\begin{tabularx}{\textwidth}
    ...
    \ntableCyan     Attori              & Codemonkey
    \tableCyan      Relazioni           & Autenticazione
    \ntableCyan     Precondizioni       & Il Collaborazione è stata proposta alla Codemonkey
...
\begin{tabularx}{\textwidth}
    ...
    \ntableCyan     Attori              & Codemonkey
    \tableCyan      Relazioni           & Autenticazione
    \ntableCyan     Precondizioni       & La Collaborazione è stata già accettata dalla Codemonkey
