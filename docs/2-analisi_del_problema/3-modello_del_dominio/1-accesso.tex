\noindent\resizebox{\textwidth}{!}{
    \begin{tikzpicture}
        ...
        \draw [{Latex[open]}-] (User) -- (RegistredUser);
        ...
        \draw [{Latex[open]}-] (RegistredUser) -- (Cliente);
        ...
        \begin{class}[text width=5cm, fill=green!20, draw=black]{Action}{-18,4}
        \end{class}
        \draw [-{Latex[]}] (Login) -- (Action);
        \draw [-{Latex[]}] (Registrazione) -- (Action);

        %%%%%%%%%%
        \begin{class}[text width=5cm, fill=green!20, draw=black, below=8cm of RegistredUser, xshift=-14cm]{Admin}{0,0}
        \end{class}
        
        \draw[-{Latex[open]}] (Admin) -- (User);
