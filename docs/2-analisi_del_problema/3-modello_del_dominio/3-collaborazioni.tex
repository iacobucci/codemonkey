\noindent\resizebox{\textwidth}{!}{
    \begin{tikzpicture}
        ...
        % \draw [-{Latex[]}] (Cliente) -- (ActionCollaborazione);
        % \draw [-{Latex[]}] (Codemonkey) -- (ActionCollaborazione);
        
        \begin{class}[text width=5cm, fill=green!20, draw=black, below=11cm of Collaborazione]{Action}{0,0}
        \end{class}
        \draw [-{Latex[]}] (Cliente) -- (Action);
