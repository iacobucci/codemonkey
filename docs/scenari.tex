...
\begin{tabularx}{\textwidth}
    ...
    \tableCyan      Punti Aperti        & Nel caso la Codmonkey annulli una proposta di Lavoro dovrá fornire una motivazione, in modo che il Cliente capisca rapidamente cosa é andato storto, inoltre ció migliorerá i tempi di risposta dell'Amministratore nel caso di segnalazione da parte del Cliente
    \n
\end{tabularx}
